...
public class BaseFluidPipeEntity extends LootableContainerBlockEntity implements Inventory {
    ...
    public BaseFluidPipeEntity(BlockEntityType<?> blockEntityType, BlockPos blockPos, BlockState blockState, MoveType moveType) {
        ...
        for (Direction direction : Direction.values()) {
            ...
            if (world.isPosLoaded(pos)) {
                ...
                if (state.contains(ModBlockStateProperties.HAS_ELECTRICITY)) {
                    if (world.getBlockEntity(pos) instanceof BasePipeEntity entity) {
