...
public final class ModBlocks {
    ...
    public static final Block WEATHERED_COPPER_PIPE = register("weathered_copper_pipe",
        ...
        AbstractBlock.Settings.create().mapColor(MapColor.DARK_AQUA)
            .requiresTool()
            .strength(1.5F, 3F)
            .sounds(BlockSoundGroup.COPPER)
    );
    public static final Block OXIDIZED_COPPER_PIPE = register("oxidized_copper_pipe",
        ...
        AbstractBlock.Settings.create().mapColor(MapColor.TEAL)
            .requiresTool()
            .strength(1.5F, 3F)
            .sounds(BlockSoundGroup.COPPER)
    );
    ...
    public static final Block WAXED_EXPOSED_COPPER_PIPE = register("waxed_exposed_copper_pipe",
        ...
        AbstractBlock.Settings.create().mapColor(MapColor.TERRACOTTA_LIGHT_GRAY)
            .requiresTool()
            .strength(1.5F, 3F)
            .sounds(BlockSoundGroup.COPPER)
    );
...
//        return Identifier.of(Global.NAMESPACE, path);
//    }
